...
@Component({
  selector: 'app-edit-upi-credentials',
  templateUrl: './edit-upi-credentials.component.html',
  styleUrls: ['./edit-upi-credentials.component.css']
})
export class EditUpiCredentialsComponent implements OnInit {
