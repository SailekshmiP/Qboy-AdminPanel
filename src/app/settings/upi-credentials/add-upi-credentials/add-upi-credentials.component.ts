...
@Component({
  selector: 'app-add-upi-credentials',
  templateUrl: './add-upi-credentials.component.html',
  styleUrls: ['./add-upi-credentials.component.css']
})
export class AddUpiCredentialsComponent implements OnInit {
