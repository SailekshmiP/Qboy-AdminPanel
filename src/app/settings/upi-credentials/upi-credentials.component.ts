...
@Component({
  selector: 'app-upi-credentials',
  templateUrl: './upi-credentials.component.html',
  styleUrls: ['./upi-credentials.component.css']
})
export class UpiCredentialsComponent implements OnInit {
